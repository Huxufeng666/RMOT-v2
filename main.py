...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='/RMOT/exps/e2e_motr_r50_joint/motr_final.pth', help='resume from checkpoint')
    parser.add_argument('--start_epoch', default=49, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--eval', action='store_true')
    parser.add_argument('--vis', action='store_true')
    parser.add_argument('--num_workers', default=0, type=int)
    parser.add_argument('--pretrained', default="/RMOT/exps/e2e_motr_r50_joint/motr_final.pth", help='resume from checkpoint')
    parser.add_argument('--cache_mode', default=False, action='store_true', help='whether to cache images on memory')

    # end-to-end mot settings.
    parser.add_argument('--mot_path', default='./data/Dataset/mot', type=str)
    parser.add_argument('--input_video', default='/RMOT/dataset/data/short_peddestrain_track.mp4', type=str)
    parser.add_argument('--data_txt_path_train',
                        default='./datasets/data_path/joint_copy.train', type=str,
    ...
    parser.add_argument('--sampler_steps', type=int, nargs='*',default=[50, 90, 150])
...
def main(args):
    ...
    if args.dataset_file in ['e2e_mot', 'e2e_dance', 'mot', 'ori_mot', 'e2e_static_mot', 'e2e_joint']:
        ...
        dataset_train.set_epoch(args.start_epoch) #训练的epoch开始的次数
...
#     --extra_track_attn \
#     --resume exps_1/e2e_motr_r50_joint/motr_final.pth \
#     --input_video dataset/data/station.mp4