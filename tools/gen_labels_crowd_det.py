...
if __name__ == '__main__':
    data_val = '/RMOT/data/Dataset/mot/crowdhuman/images/val'
    label_val = '/RMOT/data/Dataset/mot/crowdhuman/labels_with_ids/val'
    ann_val = '/RMOT/dataset/data/CrowdHuman_zip/annotation_val.odgt'
    # data_train = '/RMOT/dataset/data/crowdhuman/Images/train'
    # label_train = '/RMOT/dataset/data/crowdhuman/labels_with_ids/train'
    # ann_train = '/RMOT/dataset/data/crowdhuman/annotation_train.odgt'
